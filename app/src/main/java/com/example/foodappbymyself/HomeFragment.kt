...
import com.example.foodappbymyself.Adapters.ImageSliderAdapter
import com.example.foodappbymyself.Adapters.PopularAdapter
import com.example.foodappbymyself.Fragments.MenuBottomSheerFragment
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        listPopular.add(PopularModel(R.drawable.pop_menu_burger, "Сендвич",7, 7,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_sandwich, "Момо",8, 8,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_momo, "Бургер",5, 5,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_burger, "Сендвич",7, 7,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_sandwich, "Момо",8, 8,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_momo, "Бургер",5, 5,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_burger, "Сендвич",7, 7,1))
